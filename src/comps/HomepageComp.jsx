	...
	return (
		<div className="center">
			<div className="wallpaper">
				<img
					className="homepage"
					src="https://m.media-amazon.com/images/I/81OrRaToxJL._AC_SL1500_.jpg"
					loading="lazy"
				/>
				<div className="desc">
					<h2>PedPad™ - Human sized dog bed</h2>
					<p>😍 No need for assembly and it's washable</p>
					<p>🐶 Ultra cozy beds for humans and non-humans</p>
					<p>🛏️ Convenient with large space and easy storage</p>
			...
			<div className="iconRow">
				<div className="icon">
					<img
						src="https://img.icons8.com/m_outlined/1200/truck.jpg"
						loading="lazy"
					/>
					<p>
						<b>FREE SHIPPING</b>
				...
				<div className="icon">
					<img
						src="https://cdn3.iconfinder.com/data/icons/unboxing/64/02_Box_Unboxing_open_delivery_packaging-1024.png"
						loading="lazy"
					/>
					<p>
				...
				<div className="icon">
					<img
						src="https://thumbs.dreamstime.com/b/person-stars-line-icon-achievement-success-recognition-outline-symbol-personal-excellence-talent-representation-385464883.jpg"
						loading="lazy"
					/>
					<p>
						<b>5 STAR RATINGS</b>
